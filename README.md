...
- rosdistro version: `0.26.10-2`
- old version: `0.26.10-2`
...
## rosbag2 (lyrical) - 0.33.3-1

The packages in the `rosbag2` repository were released into the `lyrical` distro by running `/usr/local/google/home/sloretz/projects/lyrical/env3/bin/bloom-release -r lyrical -t lyrical rosbag2` on `Tue, 12 May 2026 19:17:37 -0000`
...
- upstream repository: https://github.com/ros2/rosbag2.git
- release repository: https://github.com/ros2-gbp/rosbag2-release.git
- rosdistro version: `0.33.1-3`
- old version: `0.33.1-3`
...
## rosbag2 (rolling) - 0.33.1-1

The packages in the `rosbag2` repository were released into the `rolling` distro by running `/usr/local/google/home/sloretz/projects/lyrical/env3/bin/bloom-release rosbag2 --rosdistro rolling --track rolling` on `Wed, 15 Apr 2026 01:09:14 -0000`
...
## rosbag2 (jazzy) - 0.26.10-2

The packages in the `rosbag2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy rosbag2` on `Wed, 08 Apr 2026 21:03:53 -0000`
...
## rosbag2 (humble) - 0.15.16-1

The packages in the `rosbag2` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble rosbag2` on `Wed, 04 Feb 2026 07:25:02 -0000`
...
- upstream repository: https://github.com/ros2/rosbag2.git
- release repository: https://github.com/ros2-gbp/rosbag2-release.git
- rosdistro version: `0.15.15-1`
- old version: `0.15.15-1`
- new version: `0.15.16-1`
...
## rosbag2 (jazzy) - 0.26.10-1

The packages in the `rosbag2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy rosbag2` on `Sat, 24 Jan 2026 12:41:01 -0000`
...
## rosbag2 (jazzy) - 0.26.9-1

The packages in the `rosbag2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy rosbag2` on `Tue, 12 Aug 2025 07:03:54 -0000`
...
## rosbag2 (humble) - 0.15.15-1

The packages in the `rosbag2` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble rosbag2` on `Wed, 16 Jul 2025 19:52:44 -0000`
...
- upstream repository: https://github.com/ros2/rosbag2.git
- release repository: https://github.com/ros2-gbp/rosbag2-release.git
- rosdistro version: `0.15.14-1`
- old version: `0.15.14-1`
- new version: `0.15.15-1`
...
## rosbag2 (jazzy) - 0.26.8-1

The packages in the `rosbag2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy rosbag2` on `Sat, 12 Jul 2025 05:25:25 -0000`
...
## rosbag2 (rolling) - 0.33.0-1

The packages in the `rosbag2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rosbag2` on `Sat, 26 Apr 2025 03:01:14 -0000`
...
The packages in the `rosbag2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy rosbag2` on `Wed, 23 Apr 2025 05:09:49 -0000`
...
## rosbag2 (rolling) - 0.32.0-1

The packages in the `rosbag2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rosbag2` on `Fri, 18 Apr 2025 22:49:43 -0000`
...
## rosbag2 (humble) - 0.15.14-1

The packages in the `rosbag2` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble -y rosbag2` on `Wed, 26 Mar 2025 15:18:38 -0000`
...
- old version: `0.15.13-1`
- new version: `0.15.14-1`
...
## rosbag2 (rolling) - 0.31.0-1

The packages in the `rosbag2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling rosbag2` on `Tue, 04 Feb 2025 05:30:22 -0000`
...
The packages in the `rosbag2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy rosbag2` on `Fri, 20 Dec 2024 14:43:58 -0000`
